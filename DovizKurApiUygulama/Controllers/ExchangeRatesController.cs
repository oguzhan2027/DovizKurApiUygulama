...
namespace DovizKurApiUygulama.Controllers
{
    ...
    { 
        ...
        public async Task<IActionResult> GetExchangeRates()
        {
            ...
            string url = $"https://evds2.tcmb.gov.tr/service/evds/series=TP.DK.USD.S.YTL-TP.DK.EUR.S.YTL-TP.DK.CHF.S.YTL-TP.DK.GBP.S.YTL-TP.DK.JPY.S.YTL&startDate={startDate}&endDate={endDate}&type=xml&key=uQKtcrolI7";
